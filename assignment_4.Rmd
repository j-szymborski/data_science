...
title: | 
  ...
  | 2022-2023
author: |
  | Jan Szymborski-Dyrda
  | J.Szymborski-Dyrda@students.uu.nl
  | http://www.github.com/j-szymborski
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
The table that Janek received shows the mean for growth to be 2.46 (-morris)
...
```{r}
library(kableExtra)
final_table <- list(model1, model2, model3, model4) |>
  modelsummary(stars=T, gof_map = c("nobs", "r.squared")) |>
  kable_styling() |>
